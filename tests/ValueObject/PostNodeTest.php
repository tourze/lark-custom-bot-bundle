 ...
 * @internal
 */
#[CoversClass(PostNode::class)]
final class PostNodeTest extends TestCase
{
    public function testStaticFactoryMethodsWithValidData(): void
    {
        $textContent = '测试内容';
        $userId = 'user_id_123';
    ...
    public function testJsonSerializeWithTextNodeReturnsCorrectStructure(): void
    {
        $content = '测试内容';
    ...
    public function testJsonSerializeWithAtNodeReturnsCorrectStructure(): void
    {
        $userId = 'user_id_123';
    ...
    public function testJsonSerializeWithAtNodeAndUsernameReturnsCorrectStructure(): void
    {
        $userId = 'user_id_123';
        $userName = 'User Name';
    ...
    public function testJsonSerializeWithImageNodeReturnsCorrectStructure(): void
    {
        $imageKey = 'image_key_123';
    ...
    public function testJsonSerializeWithLinkNodeReturnsCorrectStructure(): void
    {
        $text = 'Link Text';
    ...
    public function testJsonSerializeWithMediaNodeReturnsCorrectStructure(): void
    {
    ...
    public function testJsonSerializeWithEmotionNodeReturnsCorrectStructure(): void
    {
